...
imge=Image.open("E:/Class_shedular_codefest2019ccs/Background.jpg")
...
def printSomething_0():
        label_1 = Label(root, fg="white",bg="#CF2B5D",text=present_list)
        label_1.place(x=760, y=240)
        label_2 = Label(root, fg="white",bg="#CF2B5D",text=absent_list)
        label_2.place(x=760, y=270)

def pre():
    winpre=Tk()
    winpre.geometry("300x200")
    winpre.title("Presented Teachers")
    winpre.config(background='#2D317E')
    labb=Label(winpre,bg="#CF2B5D",fg="white",text="Presented Teachers",font=("bold",12)).pack(fill=BOTH)
    label_1 = Label(winpre,bg="#2D317E",fg="white",text=present_list)
    label_1.pack()
    winpre.mainloop()
def abb():
    winabb=Tk()
    winabb.geometry("300x200")
    winabb.title("Absent Teachers")
    winabb.config(background='#2D317E')
    labb=Label(winabb,bg="#CF2B5D",fg="white",text="Absent Teachers",font=("bold",12)).pack(fill=BOTH)
    label_2 = Label(winabb, fg="white",bg="#2D317E",text=absent_list)
    label_2.pack()
    winabb.mainloop()
...
but_login = Button(root, text="Details", width=12, bg="#CF2B5D", fg="white", command=second_win).place(x=205, y=550)
but_test = Button(root, text="Test",width=12, bg="#CF2B5D", fg="white", command=printSomething_0).place(x=335, y=550)
